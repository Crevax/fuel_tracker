...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FuelUp.complete_fill'
        db.add_column(u'fuel_tracker_fuelup', 'complete_fill',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FuelUp.complete_fill'
        db.delete_column(u'fuel_tracker_fuelup', 'complete_fill')
    ...
    models = {
        ...
        u'fuel_tracker.fuelup': {
            ...
            'complete_fill': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
